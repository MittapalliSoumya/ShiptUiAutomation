...
public abstract class BasePage {
    ...
    public static WebDriver getSeleniumgridRemoteDriver(String browserType) throws MalformedURLException {
        LOGGER.info("==> Get new driver for browser : " + browserType);
        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();

        desiredCapabilities.setPlatform(Platform.LINUX);
        desiredCapabilities.setBrowserName(String.valueOf(browserType));
        //WebDriver driver = new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), desiredCapabilities);
        return getNewDriver(BrowserType.CHROME);
    ...
    /***
     * This method is used to wait for visibility of given element using By locator for a given timeout
     * @param locator - locator of the element
     * @param maxTimeout - timeout it has to wait for the element invisibility
     */
    public void waitForElementVisibility(By locator, long maxTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, maxTimeout);
